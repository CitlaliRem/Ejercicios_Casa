...
GLfloat JupiterAmbiental[] = { 0.2125f, 0.1275f, 0.054f, 1.0f };
GLfloat JupiterDiffuse[] = { 0.714f, 0.4284f, 0.18144f, 1.0f };			// Jupiter
GLfloat JupiterSpecular[] = { 0.393548f, 0.271906f, 0.166721f, 1.0f };
GLfloat JupiterShininess[] = { 0.2 };

GLfloat SaturnoAmbiental[] = { 0.0215f, 0.1745f, 0.0215f, 1.0f };
GLfloat SaturnoDiffuse[] = { 0.07568f, 0.61424f, 0.07568f, 1.0f };			// Saturno
GLfloat SaturnoSpecular[] = { 0.633f, 0.727811f, 0.633f, 1.0f };
GLfloat SaturnoShininess[] = { 0.6 };

GLfloat Anillo1Ambiental[] = { 0.135f, 0.2225f, 0.1575f, 1.0f };
GLfloat Anillo1Diffuse[] = { 0.54f, 0.89f, 0.63f, 1.0f };			// Anillo1
GLfloat Anillo1Specular[] = { 0.316228f, 0.316228f, 0.316228f, 1.0f };
GLfloat Anillo1Shininess[] = { 0.1 };

GLfloat Anillo2Ambiental[] = { 0.329412f, 0.223529f, 0.027451f, 1.0f };
GLfloat Anillo2Diffuse[] = { 0.780392f, 0.568627f, 0.113725f, 1.0f };			// Anillo2
GLfloat Anillo2Specular[] = { 0.992157f, 0.941176f, 0.807843f, 1.0f };
GLfloat Anillo2Shininess[] = { 0.21794872 };

GLfloat UranoAmbiental[] = { 0.19225f, 0.19225f, 0.19225f, 1.0f };
GLfloat UranoDiffuse[] = { 0.50754f, 0.50754f, 0.50754f, 1.0f };			//Urano
GLfloat UranoSpecular[] = { 0.508273f, 0.508273f, 0.508273f, 1.0f };
GLfloat UranoShininess[] = { 0.4 };
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();//sistema solar
		...
		glPushMatrix();//saturno
			...
			glMaterialfv(GL_FRONT, GL_AMBIENT, SaturnoAmbiental);
			...
			//Anillo1
				glRotatef(45,1,0,0);
				glMaterialfv(GL_FRONT, GL_AMBIENT, Anillo1Ambiental);
			...
			//Anillo2
				glMaterialfv(GL_FRONT, GL_AMBIENT, Anillo2Ambiental);
		...
		glPushMatrix();//urano
			...
			glMaterialfv(GL_FRONT, GL_AMBIENT, UranoAmbiental);
...
int main ( int argc, char** argv )   // Main Function
{
  ...
  glutCreateWindow    ("Tarea 7"); // Nombre de la Ventana
