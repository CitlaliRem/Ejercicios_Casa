...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glLoadIdentity();
		...
		glPushMatrix();
		glTranslatef(-1.6, -3.4, 0); //articulación 1 der
		...
		glPushMatrix();
		glTranslatef(-1.6, -6.4, 0); //articulación 2 der
		...
		glPushMatrix();
		glTranslatef(1.6, -3.4, 0); //articulación 1 izq
		glScalef(1.5, 0.8, 1.0);
		glRotatef(180, 1, 0, 0);
		prisma();
		glPopMatrix();
		...
		glPushMatrix();
		glTranslatef(1.6, -6.4, 0); //articulación 2 izq
		glScalef(1.9, 1.0, 1.0);
		prisma2();
		glPopMatrix();
