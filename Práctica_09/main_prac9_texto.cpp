...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_madera1.LoadTGA("madera1.tga");
	t_madera1.BuildGLTexture();
	t_madera1.ReleaseImage();

	t_madera2.LoadTGA("madera2.tga");
	t_madera2.BuildGLTexture();
	t_madera2.ReleaseImage();

	t_metal02.LoadTGA("metal02.tga");
	t_metal02.BuildGLTexture();
	t_metal02.ReleaseImage();

	t_metal03.LoadTGA("metal1.tga");
	t_metal03.BuildGLTexture();
	t_metal03.ReleaseImage();
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	//modificado:
		...
		glPushMatrix(); //pata delantera izquierda
			...
			prisma2(t_madera1.GLindex, t_madera2.GLindex);
		glPopMatrix();
		...
		glPushMatrix();//borde derecho
			...
			prisma2(t_metal02.GLindex, t_metal03.GLindex);
		glPopMatrix();
